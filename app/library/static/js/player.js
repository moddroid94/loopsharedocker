...
function SelectSample(parentElement, audiosrc, filename){
    ...
    audio.setAttribute("title", filename)
  ...
  class AudioPlayer extends HTMLElement {
    ...
    render() {
      this.shadowRoot.innerHTML = `
        ...
        <div class="appearance-none audio-player flex flex-row px-4 w-full">
          <figcaption class="audio-name appearance-none"></figcaption>
          <audio class="appearance-none" style="display: none"></audio>
          <button id="audio-play" class="appearance-none basis-8 shrink-0 transition ease-in-out my-2 self-center bg-white bg-clip-border rounded-full p-2 hover:bg-indigo-300 hover:shadow-lg play-btn" type="button">play</button>
